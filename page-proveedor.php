<?php
editar_usuario();
$proveedor->update_postadata();
$proveedor->actualizar_empresa();
 /* Template Name: Cuenta proveedor */ 


if (is_user_logged_in() == false || get_rol_user() == 'subscriber' || get_rol_user() == 'premium' ||  get_rol_user() == 'premium_premium') {
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                     <div class="dashboard-menu-container">
                        <ul id="pills-tab" role="tablist">
                             ...
                             <?php if (get_rol_user() == 'administrator' || get_rol_user() == 'proveedor' ) {
                               ?>
                                                     <li>
                              <a id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">
                                 <div class="icon"><i class="fa fa-star-o"></i></div>
                                 <div class="menue-name">EMPRESA</div>
                              </a>
                           </li>
...
<section class="dashboard light-blue " id="pills-profile" role="tabpanel" >
 ...
 <a href="<?php echo $proveedor->get_postdata( 'link' ) ?>"><?php echo $proveedor->get_postdata( 'link' ) ?></a>
</div>
                  <div class="col-md-12 col-sm-12 col-xs-12 " >
                        ...
                        <div class="col-md-12 col-xs-12 col-sm-12">
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-8">
                                    <input type="text" class="form-control" name="titulo" placeholder="Ingrese Titulo" value="<?php echo $proveedor->obtener_proveedor('title'); ?>">
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-8">
                                    <textarea class="form-control" id="contact_list" name="descripcion"><?php echo $proveedor->obtener_proveedor('content'); ?></textarea>
                                 </div>
                              </div>
                           </div>
...
<div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                              <div class="form-group toggle-btn">
                                 ...
                                 <div class="col-sm-8">
                                    <input <?php if ( $proveedor->obtener_proveedor_users('servicio') == 'on') {
                                      echo 'checked';
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                              <div class="form-group toggle-btn">
                                 ...
                                 <div class="col-sm-8">
                                    <input <?php if ( $proveedor->obtener_proveedor_users('dropshipping')) {
                                      echo 'checked';
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                              <div class="form-group toggle-btn">
                                 ...
                                 <div class="col-sm-8">
                                    <input <?php if ( $proveedor->obtener_proveedor_users('mayor') == 'on') {
                                      echo 'checked';
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                              <div class="form-group toggle-btn">
                                 ...
                                 <div class="col-sm-8">
                                    <input <?php if ($proveedor->obtener_proveedor_users('fabricante') == 'on') {
                                      echo 'checked';
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                              <div class="form-group toggle-btn">
                                 ...
                                 <div class="col-sm-8">
                                    <input <?php if ($proveedor->obtener_proveedor_users('liquidador') == 'on') {
                                      echo 'checked';
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                              <div class="form-group toggle-btn">
                                 ...
                                 <div class="col-sm-8">
                                    <input <?php if ( $proveedor->obtener_proveedor_users('menor') == 'on') {
                                      echo 'checked';
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                              <div class="form-group toggle-btn">
                                 ...
                                 <div class="col-sm-8">
                                    <input name="imagen1"  class="form-control" type="text" value="<?php $proveedor->get_postdata('imagen1'); ?>">
                                 </div>
                              </div>
                           </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                              <div class="form-group toggle-btn">
                                 ...
                                 <div class="col-sm-8">
                                    <input name="imagen2"  class="form-control" type="text"  value="<?php $proveedor->get_postdata('imagen2'); ?>" >
                                 </div>
                              </div>
                           </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                              <div class="form-group toggle-btn">
                                 ...
                                 <div class="col-sm-8">
                                    <input name="imagen3"  class="form-control" type="text"  value="<?php $proveedor->get_postdata('imagen3'); ?>">
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-8">
                                    <input type="text" class="form-control" name="legal" placeholder="Ingrese Titulo" value="<?php echo $proveedor->get_postdata('legal'); ?>">
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-8">
                                    <textarea type="text" class="form-control"  name="quieneson"  value=""> <?php echo $proveedor->get_postdata('quieneson'); ?></textarea>
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-8">
                                    <textarea type="text"  class="form-control"  name="reqtrab"  value=""> <?php echo $proveedor->get_postdata('reqtrab'); ?></textarea>
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-8">
                                    ...
                                    <option><?php echo $proveedor->get_postdata('envios'); ?></option>
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-8">
                                    <textarea type="text" class="form-control" name="lismarcas" id="lismarcas" style="margin-top:20px;"><?php echo $proveedor->get_postdata('marcas'); ?></textarea>                                    
                                 </div>
    ...
    text-decoration: underline;">Diesel</a></li></ul></div>
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-8">
                                    <input type="text" class="form-control" name="sitioweb" placeholder="Sitio Web" value="<?php echo $proveedor->get_postdata('sitio'); ?>">
                                 </div>
                              </div>
                           </div>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-8">
                                    <select class="select-general form-control" name="pedido">
                                       <option label="Select Option"><?php echo $proveedor->get_postdata('pedido'); ?></option>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-8">
                                    <select class="select-general form-control" name="comprar">
                                       <option label="Select Option"><?php echo $proveedor->get_postdata('comprar'); ?></option>
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-8">
                                    <input type="text" class="form-control" name="fax" placeholder="Fax" value="<?php echo $proveedor->get_postdata('fax'); ?>">
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-8">
                                    <input type="text" class="form-control" name="codpostal" placeholder="Código postal" value="<?php echo $proveedor->get_postdata('codpostal'); ?>">
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-8">
                                    <input type="text" class="form-control" name="antiguedad" placeholder="Antigüedad" value="<?php echo $proveedor->get_postdata('antiguedad'); ?>">
                                 </div>
                              </div>
                           </div>
